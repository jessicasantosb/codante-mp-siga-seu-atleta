...
import { CardGrainyBackground } from "@/components/CardGrainyBackground";
import {
  Avatar,
  AvatarImage,
  Card,
...
export function AthleteCard({ athlete }: AthleteCardProps) {
  return (
    <div className="relative group">
      <Card className="transform transition-transform group-hover:translate-x-2 group-hover:translate-y-2">
