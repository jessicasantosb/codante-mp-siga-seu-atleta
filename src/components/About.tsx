        ...
        <DialogHeader>
          ...
          <DialogDescription>
            <p>
              ...
              com o objetivo de aprender mais sobre o NextJS, Shadcn UI, Prisma
              e SQLite.
            </p>
            <br />
            <p>
              Com essa aplicação conseguimos ajudar a dar mais visibiliade para
              os atletas olímpicos e paralímpicos brasileiros.
            </p>
          </DialogDescription>
        </DialogHeader>
      </DialogContent>
